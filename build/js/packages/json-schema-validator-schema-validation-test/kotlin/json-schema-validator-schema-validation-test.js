(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'json-schema-validator-schema-validation-test'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'json-schema-validator-schema-validation-test'.");
    }if (typeof this['json-schema-validator-schema-validation'] === 'undefined') {
      throw new Error("Error loading module 'json-schema-validator-schema-validation-test'. Its dependency 'json-schema-validator-schema-validation' was not found. Please, check whether 'json-schema-validator-schema-validation' is loaded prior to 'json-schema-validator-schema-validation-test'.");
    }if (typeof this['kotlin-test'] === 'undefined') {
      throw new Error("Error loading module 'json-schema-validator-schema-validation-test'. Its dependency 'kotlin-test' was not found. Please, check whether 'kotlin-test' is loaded prior to 'json-schema-validator-schema-validation-test'.");
    }if (typeof this['kotlinx-serialization-kotlinx-serialization-json-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'json-schema-validator-schema-validation-test'. Its dependency 'kotlinx-serialization-kotlinx-serialization-json-js-legacy' was not found. Please, check whether 'kotlinx-serialization-kotlinx-serialization-json-js-legacy' is loaded prior to 'json-schema-validator-schema-validation-test'.");
    }root['json-schema-validator-schema-validation-test'] = factory(typeof this['json-schema-validator-schema-validation-test'] === 'undefined' ? {} : this['json-schema-validator-schema-validation-test'], kotlin, this['json-schema-validator-schema-validation'], this['kotlin-test'], this['kotlinx-serialization-kotlinx-serialization-json-js-legacy']);
  }
  ...
  var any = $module$json_schema_validator_schema_validation.org.validator.rules.any;
  var assertEquals = $module$kotlin_test.kotlin.test.assertEquals_3m0tl5$;
  var Kind_CLASS = Kotlin.Kind.CLASS;
  var test = $module$kotlin_test.kotlin.test.test;
  var suite = $module$kotlin_test.kotlin.test.suite;
  var listOf = Kotlin.kotlin.collections.listOf_i5x0yv$;
  var OrValidationRule = $module$json_schema_validator_schema_validation.org.validator.OrValidationRule;
  ...
  Kotlin.defineModule('json-schema-validator-schema-validation-test', _);
  return _;
}));

//# sourceMappingURL=json-schema-validator-schema-validation-test.js.map
