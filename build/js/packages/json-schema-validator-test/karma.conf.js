...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "/Users/tfernandez/projects/json-schema-validator/build/js/packages/json-schema-validator-test/node_modules",
  "files": [
    "/Users/tfernandez/projects/json-schema-validator/build/js/packages/json-schema-validator-test/adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
  "client": {
    "args": [
      "--include",
      "org.validator.testing.PlatformLoaderTest"
    ]
  },
  "browsers": [
    "ChromeHeadless"
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("/Users/tfernandez/projects/json-schema-validator/build/js", 'g'), '');;
        console.log(msg);
    };
