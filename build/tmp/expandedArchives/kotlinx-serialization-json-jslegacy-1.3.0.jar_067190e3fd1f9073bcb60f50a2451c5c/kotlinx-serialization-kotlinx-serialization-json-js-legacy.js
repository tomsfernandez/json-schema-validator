(function (root, factory) {
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            if (this.local$lastToken !== TC_COMMA && this.local$lastToken !== TC_END_OBJ) {
  ...
  JsonTreeReader.prototype.read = function () {
    ...
    switch (token) {
      ...
      case 8:
        ...
        break;
      default:tmp$_0 = this.lexer_0.fail_bm4lxs$('Cannot begin reading element, unexpected token: ' + token);
        break;
    }
    return tmp$_0;
  };
        ...
        switch (this.state_0) {
          case 0:
            switch (this.local$this$JsonTreeReader.lexer_0.peekNextToken()) {
              ...
              default:return this.local$this$JsonTreeReader.lexer_0.fail_bm4lxs$("Can't begin reading element, unexpected token");
            }
  ...
  StreamingJsonDecoder.prototype.beginStructure_24f42q$ = function (descriptor) {
    ...
    switch (newMode.name) {
      ...
      case 'POLY_OBJ':
        ...
        break;
      default:if (this.mode_0 === newMode && this.json.configuration.explicitNulls) {
          tmp$ = this;
        } else {
          tmp$ = new StreamingJsonDecoder(this.json, newMode, this.lexer_8be2vx$, descriptor);
        }
  ...
  function carrierDescriptor($receiver, module_0) {
    ...
    if (equals($receiver.kind, SerialKind.CONTEXTUAL))
      ...
      return $receiver.getElementDescriptor_za3lpa$(0);
    else
      return $receiver;
  }
  var lenientHint;
  ...
  AbstractJsonLexer.prototype.expectEof = function () {
    ...
    if (nextToken !== TC_EOF)
      this.fail_bm4lxs$('Expected EOF after parsing an object, but had ' + String.fromCharCode(this.source.charCodeAt(this.currentPosition_0 - 1 | 0)) + ' instead');
  };
  ...
  AbstractJsonLexer.prototype.consumeNextToken_s8itvh$ = function (expected) {
    ...
    while (true) {
      cpos = this.definitelyNotEof_za3lpa$(cpos);
      if (cpos === -1)
        break;
  ...
  AbstractJsonLexer.prototype.fail_0 = function (expectedToken) {
    var tmp$;
  ...
  AbstractJsonLexer.prototype.tryConsumeNotNull = function () {
    ...
    current = this.definitelyNotEof_za3lpa$(current);
  ...
  AbstractJsonLexer.prototype.consumeString2 = function (source, startPosition, current) {
    ...
    while (char !== STRING) {
      if (char === STRING_ESC) {
        ...
        currentPosition = this.definitelyNotEof_za3lpa$(currentPosition);
  ...
  AbstractJsonLexer.prototype.consumeStringLenient = function () {
    ...
    while (charToTokenClass(this.source.charCodeAt(current)) === TC_OTHER) {
      ...
      if (current >= this.source.length) {
        ...
        var eof = this.definitelyNotEof_za3lpa$(current);
        if (eof === -1) {
          this.currentPosition_0 = current;
  ...
  AbstractJsonLexer.prototype.consumeBoolean2 = function (start) {
    var tmp$, tmp$_0;
    var current = this.definitelyNotEof_za3lpa$(start);
    if (current >= this.source.length || current === -1)
      this.fail_bm4lxs$('EOF');
  ...
  StringJsonLexer.prototype.definitelyNotEof_za3lpa$ = function (position) {
