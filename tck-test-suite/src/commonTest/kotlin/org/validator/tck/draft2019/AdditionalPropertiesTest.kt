...
public class AdditionalPropertiesTest {
  ...
  public fun additionalProperties_being_false_does_not_allow_other_properties(): Unit {
    ...
    val `no_additional_properties_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `no_additional_properties_is_valid`, true, "DRAFT_2019_09")
    val `an_additional_property_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `an_additional_property_is_invalid`, false, "DRAFT_2019_09")
    val `ignores_arrays` = """
        |[
        |    1,
        |    2,
    ...
    val `patternProperties_are_not_additional_properties` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `patternProperties_are_not_additional_properties`, true, "DRAFT_2019_09")
  }
  ...
  public fun non_ASCII_pattern_with_additionalProperties(): Unit {
    ...
    val `matching_the_pattern_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `matching_the_pattern_is_valid`, true, "DRAFT_2019_09")
    val `not_matching_the_pattern_is_invalid` = """
        |{
        |    "élmény": 2
        |}
        """.trimMargin()
    run_test(schema, `not_matching_the_pattern_is_invalid`, false, "DRAFT_2019_09")
  }
  ...
  public fun additionalProperties_allows_a_schema_which_should_validate(): Unit {
    ...
    val `an_additional_valid_property_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `an_additional_valid_property_is_valid`, true, "DRAFT_2019_09")
    val `an_additional_invalid_property_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `an_additional_invalid_property_is_invalid`, false, "DRAFT_2019_09")
  }
  ...
  public fun additionalProperties_are_allowed_by_default(): Unit {
    ...
    val `additional_properties_are_allowed` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `additional_properties_are_allowed`, true, "DRAFT_2019_09")
  }
  ...
  public fun additionalProperties_should_not_look_in_applicators(): Unit {
    ...
    val `properties_defined_in_allOf_are_not_examined` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `properties_defined_in_allOf_are_not_examined`, false, "DRAFT_2019_09")
  }
}
