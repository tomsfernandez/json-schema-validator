...
public class AllOfTest {
  ...
  public fun allOf(): Unit {
    ...
    val `allOf` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `allOf`, true, "DRAFT_2019_09")
    val `mismatch_second` = """
        |{
        |    "foo": "baz"
        |}
        """.trimMargin()
    run_test(schema, `mismatch_second`, false, "DRAFT_2019_09")
    val `mismatch_first` = """
        |{
        |    "bar": 2
        |}
        """.trimMargin()
    run_test(schema, `mismatch_first`, false, "DRAFT_2019_09")
    val `wrong_type` = """
        |{
        |    "foo": "baz",
        |    "bar": "quux"
  ...
  public fun allOf_with_base_schema(): Unit {
    ...
    val `mismatch_first_allOf` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `mismatch_first_allOf`, false, "DRAFT_2019_09")
    val `mismatch_second_allOf` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `mismatch_second_allOf`, false, "DRAFT_2019_09")
    val `mismatch_both` = """
        |{
        |    "bar": 2
        |}
        """.trimMargin()
    run_test(schema, `mismatch_both`, false, "DRAFT_2019_09")
  }
  ...
  public fun allOf_simple_types(): Unit {
    ...
    run_test(schema, `valid`, true, "DRAFT_2019_09")
    val `mismatch_one` = """35"""
    run_test(schema, `mismatch_one`, false, "DRAFT_2019_09")
  }
  ...
  public fun allOf_with_one_empty_schema(): Unit {
    ...
    run_test(schema, `any_data_is_valid`, true, "DRAFT_2019_09")
  }
  ...
  public fun allOf_combined_with_anyOf__oneOf(): Unit {
    ...
    run_test(schema, `allOf__false__anyOf__false__oneOf__false`, false, "DRAFT_2019_09")
    val `allOf__false__anyOf__false__oneOf__true` = """5"""
    run_test(schema, `allOf__false__anyOf__false__oneOf__true`, false, "DRAFT_2019_09")
    val `allOf__false__anyOf__true__oneOf__false` = """3"""
    run_test(schema, `allOf__false__anyOf__true__oneOf__false`, false, "DRAFT_2019_09")
    val `allOf__false__anyOf__true__oneOf__true` = """15"""
    run_test(schema, `allOf__false__anyOf__true__oneOf__true`, false, "DRAFT_2019_09")
    val `allOf__true__anyOf__false__oneOf__false` = """2"""
    run_test(schema, `allOf__true__anyOf__false__oneOf__false`, false, "DRAFT_2019_09")
    val `allOf__true__anyOf__false__oneOf__true` = """10"""
    run_test(schema, `allOf__true__anyOf__false__oneOf__true`, false, "DRAFT_2019_09")
    val `allOf__true__anyOf__true__oneOf__false` = """6"""
    run_test(schema, `allOf__true__anyOf__true__oneOf__false`, false, "DRAFT_2019_09")
    val `allOf__true__anyOf__true__oneOf__true` = """30"""
    run_test(schema, `allOf__true__anyOf__true__oneOf__true`, true, "DRAFT_2019_09")
  }
}
