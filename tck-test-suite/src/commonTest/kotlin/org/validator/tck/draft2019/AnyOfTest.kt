...
public class AnyOfTest {
  ...
  public fun anyOf(): Unit {
    ...
    run_test(schema, `first_anyOf_valid`, true, "DRAFT_2019_09")
    val `second_anyOf_valid` = """2.5"""
    run_test(schema, `second_anyOf_valid`, true, "DRAFT_2019_09")
    val `both_anyOf_valid` = """3"""
    run_test(schema, `both_anyOf_valid`, true, "DRAFT_2019_09")
    val `neither_anyOf_valid` = """1.5"""
    run_test(schema, `neither_anyOf_valid`, false, "DRAFT_2019_09")
  }
  ...
  public fun anyOf_with_base_schema(): Unit {
    ...
    run_test(schema, `one_anyOf_valid`, true, "DRAFT_2019_09")
    val `both_anyOf_invalid` = """"foo""""
    run_test(schema, `both_anyOf_invalid`, false, "DRAFT_2019_09")
  }
  ...
  public fun anyOf_complex_types(): Unit {
    ...
    val `first_anyOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `first_anyOf_valid_complex`, true, "DRAFT_2019_09")
    val `second_anyOf_valid_complex` = """
        |{
        |    "foo": "baz"
        |}
        """.trimMargin()
    run_test(schema, `second_anyOf_valid_complex`, true, "DRAFT_2019_09")
    val `both_anyOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_anyOf_valid_complex`, true, "DRAFT_2019_09")
    val `neither_anyOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `neither_anyOf_valid_complex`, false, "DRAFT_2019_09")
  }
