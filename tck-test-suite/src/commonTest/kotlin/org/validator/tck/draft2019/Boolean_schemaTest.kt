...
public class Boolean_schemaTest {
  ...
  public fun `boolean_schema_'true'`(): Unit {
    ...
    run_test(schema, `boolean_true_is_valid`, true, "DRAFT_2019_09")
    val `boolean_false_is_valid` = """false"""
    run_test(schema, `boolean_false_is_valid`, true, "DRAFT_2019_09")
  ...
  public fun `boolean_schema_'false'`(): Unit {
    ...
    run_test(schema, `boolean_true_is_invalid`, false, "DRAFT_2019_09")
    val `boolean_false_is_invalid` = """false"""
    run_test(schema, `boolean_false_is_invalid`, false, "DRAFT_2019_09")
    ...
    val `array_is_invalid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_is_invalid`, false, "DRAFT_2019_09")
