...
public class If_then_elseTest {
  ...
  public fun ignore_if_without_then_or_else(): Unit {
    ...
    run_test(schema, `valid_when_valid_against_lone_if`, true, "DRAFT_2019_09")
    val `valid_when_invalid_against_lone_if` = """"hello""""
    run_test(schema, `valid_when_invalid_against_lone_if`, true, "DRAFT_2019_09")
  }
  ...
  public fun ignore_then_without_if(): Unit {
    ...
    run_test(schema, `valid_when_valid_against_lone_then`, true, "DRAFT_2019_09")
    val `valid_when_invalid_against_lone_then` = """"hello""""
    run_test(schema, `valid_when_invalid_against_lone_then`, true, "DRAFT_2019_09")
  }
  ...
  public fun ignore_else_without_if(): Unit {
    ...
    run_test(schema, `valid_when_valid_against_lone_else`, true, "DRAFT_2019_09")
    val `valid_when_invalid_against_lone_else` = """"hello""""
    run_test(schema, `valid_when_invalid_against_lone_else`, true, "DRAFT_2019_09")
  }
  ...
  public fun if_and_then_without_else(): Unit {
    ...
    run_test(schema, `valid_through_then`, true, "DRAFT_2019_09")
    val `invalid_through_then` = """-100"""
    run_test(schema, `invalid_through_then`, false, "DRAFT_2019_09")
    val `valid_when_if_test_fails` = """3"""
    run_test(schema, `valid_when_if_test_fails`, true, "DRAFT_2019_09")
  }
  ...
  public fun if_and_else_without_then(): Unit {
    ...
    run_test(schema, `valid_when_if_test_passes`, true, "DRAFT_2019_09")
    val `valid_through_else` = """4"""
    run_test(schema, `valid_through_else`, true, "DRAFT_2019_09")
    val `invalid_through_else` = """3"""
    run_test(schema, `invalid_through_else`, false, "DRAFT_2019_09")
  }
  ...
  public fun non_interference_across_combined_schemas(): Unit {
    ...
    run_test(schema, `valid__but_would_have_been_invalid_through_then`, true, "DRAFT_2019_09")
    val `valid__but_would_have_been_invalid_through_else` = """3"""
    run_test(schema, `valid__but_would_have_been_invalid_through_else`, true, "DRAFT_2019_09")
  }
  ...
  public fun if_appears_at_the_end_when_serialized_keyword_processing_sequence(): Unit {
    ...
    run_test(schema, `yes_redirects_to_then_and_passes`, true, "DRAFT_2019_09")
    val `other_redirects_to_else_and_passes` = """"other""""
    run_test(schema, `other_redirects_to_else_and_passes`, true, "DRAFT_2019_09")
    val `no_redirects_to_then_and_fails` = """"no""""
    run_test(schema, `no_redirects_to_then_and_fails`, false, "DRAFT_2019_09")
    val `invalid_redirects_to_else_and_fails` = """"invalid""""
    run_test(schema, `invalid_redirects_to_else_and_fails`, false, "DRAFT_2019_09")
  }
}
