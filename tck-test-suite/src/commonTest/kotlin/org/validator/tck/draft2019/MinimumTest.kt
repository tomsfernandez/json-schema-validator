...
public class MinimumTest {
  ...
  public fun minimum_validation(): Unit {
    ...
    run_test(schema, `above_the_minimum_is_valid`, true, "DRAFT_2019_09")
    val `boundary_point_is_valid` = """1.1"""
    run_test(schema, `boundary_point_is_valid`, true, "DRAFT_2019_09")
    val `below_the_minimum_is_invalid` = """0.6"""
    run_test(schema, `below_the_minimum_is_invalid`, false, "DRAFT_2019_09")
  ...
  public fun minimum_validation_with_signed_integer(): Unit {
    ...
    run_test(schema, `negative_above_the_minimum_is_valid`, true, "DRAFT_2019_09")
    val `positive_above_the_minimum_is_valid` = """0"""
    run_test(schema, `positive_above_the_minimum_is_valid`, true, "DRAFT_2019_09")
    val `boundary_point_is_valid` = """-2"""
    run_test(schema, `boundary_point_is_valid`, true, "DRAFT_2019_09")
    val `boundary_point_with_float_is_valid` = """-2.0"""
    run_test(schema, `boundary_point_with_float_is_valid`, true, "DRAFT_2019_09")
    val `float_below_the_minimum_is_invalid` = """-2.0001"""
    run_test(schema, `float_below_the_minimum_is_invalid`, false, "DRAFT_2019_09")
    val `int_below_the_minimum_is_invalid` = """-3"""
    run_test(schema, `int_below_the_minimum_is_invalid`, false, "DRAFT_2019_09")
    val `ignores_non_numbers` = """"x""""
    run_test(schema, `ignores_non_numbers`, true, "DRAFT_2019_09")
  }
}
