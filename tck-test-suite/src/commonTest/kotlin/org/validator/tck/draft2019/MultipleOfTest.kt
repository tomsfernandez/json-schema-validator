...
public class MultipleOfTest {
  ...
  public fun by_int(): Unit {
    val schema = """
        ...
        """.trimMargin()
    val `int_by_int` = """10"""
    run_test(schema, `int_by_int`, true, "DRAFT_2019_09")
    val `int_by_int_fail` = """7"""
    run_test(schema, `int_by_int_fail`, false, "DRAFT_2019_09")
  ...
  public fun by_number(): Unit {
    ...
    run_test(schema, `zero_is_multiple_of_anything`, true, "DRAFT_2019_09")
    val `4_5_is_multiple_of_1_5` = """4.5"""
    run_test(schema, `4_5_is_multiple_of_1_5`, true, "DRAFT_2019_09")
    val `35_is_not_multiple_of_1_5` = """35"""
    run_test(schema, `35_is_not_multiple_of_1_5`, false, "DRAFT_2019_09")
  }
  ...
  public fun by_small_number(): Unit {
    ...
    run_test(schema, `0_0075_is_multiple_of_0_0001`, true, "DRAFT_2019_09")
    val `0_00751_is_not_multiple_of_0_0001` = """0.00751"""
    run_test(schema, `0_00751_is_not_multiple_of_0_0001`, false, "DRAFT_2019_09")
  }
