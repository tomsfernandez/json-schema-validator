...
public class UnknownKeywordTest {
  ...
  public fun `$id_inside_an_unknown_keyword_is_not_a_real_identifier`(): Unit {
    ...
    run_test(schema, `type_matches_second_anyOf__which_has_a_real_schema_in_it`, true,
        "DRAFT_2019_09")
    val `type_matches_non_schema_in_first_anyOf` = """null"""
    run_test(schema, `type_matches_non_schema_in_first_anyOf`, false, "DRAFT_2019_09")
    val `type_matches_non_schema_in_third_anyOf` = """1"""
    run_test(schema, `type_matches_non_schema_in_third_anyOf`, false, "DRAFT_2019_09")
  }
}
