...
public class AdditionalPropertiesTest {
  ...
  public fun additionalProperties_being_false_does_not_allow_other_properties(): Unit {
    ...
    val `no_additional_properties_is_valid` = "{\"foo\":1}"
    run_test(schema, `no_additional_properties_is_valid`, true, "DRAFT_4")
    val `an_additional_property_is_invalid` = "{\"foo\":1,\"bar\":2,\"quux\":\"boom\"}"
    ...
    val `patternProperties_are_not_additional_properties` = "{\"foo\":1,\"vroom\":2}"
  ...
  public fun non_ASCII_pattern_with_additionalProperties(): Unit {
    val schema = "{\"patternProperties\":{\"^á\":{}},\"additionalProperties\":false}"
    val `matching_the_pattern_is_valid` = "{\"ármányos\":2}"
    run_test(schema, `matching_the_pattern_is_valid`, true, "DRAFT_4")
    val `not_matching_the_pattern_is_invalid` = "{\"élmény\":2}"
  ...
  public fun additionalProperties_allows_a_schema_which_should_validate(): Unit {
    ...
    val `no_additional_properties_is_valid` = "{\"foo\":1}"
    run_test(schema, `no_additional_properties_is_valid`, true, "DRAFT_4")
    val `an_additional_valid_property_is_valid` = "{\"foo\":1,\"bar\":2,\"quux\":true}"
    run_test(schema, `an_additional_valid_property_is_valid`, true, "DRAFT_4")
    val `an_additional_invalid_property_is_invalid` = "{\"foo\":1,\"bar\":2,\"quux\":12}"
  ...
  public fun additionalProperties_can_exist_by_itself(): Unit {
    val schema = "{\"additionalProperties\":{\"type\":\"boolean\"}}"
    val `an_additional_valid_property_is_valid` = "{\"foo\":true}"
    run_test(schema, `an_additional_valid_property_is_valid`, true, "DRAFT_4")
    val `an_additional_invalid_property_is_invalid` = "{\"foo\":1}"
    run_test(schema, `an_additional_invalid_property_is_invalid`, false, "DRAFT_4")
  }

  @Test
  public fun additionalProperties_are_allowed_by_default(): Unit {
    val schema = "{\"properties\":{\"foo\":{},\"bar\":{}}}"
    val `additional_properties_are_allowed` = "{\"foo\":1,\"bar\":2,\"quux\":true}"
  ...
  public fun additionalProperties_should_not_look_in_applicators(): Unit {
    ...
    val `properties_defined_in_allOf_are_not_examined` = "{\"foo\":1,\"bar\":true}"
