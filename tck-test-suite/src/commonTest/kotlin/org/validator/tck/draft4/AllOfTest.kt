...
public class AllOfTest {
  ...
  public fun nested_allOf__to_check_validation_semantics(): Unit {
    val schema = "{\"allOf\":[{\"allOf\":[{\"type\":\"null\"}]}]}"
