...
public class DefaultTest {
  ...
  public fun invalid_type_for_default(): Unit {
    val schema = "{\"properties\":{\"foo\":{\"type\":\"integer\",\"default\":[]}}}"
    val `valid_when_property_is_specified` = "{\"foo\":13}"
  ...
  public fun invalid_string_value_for_default(): Unit {
    ...
    val `valid_when_property_is_specified` = "{\"bar\":\"good\"}"
    run_test(schema, `valid_when_property_is_specified`, true, "DRAFT_4")
    val `still_valid_when_the_invalid_default_is_used` = "{}"
    run_test(schema, `still_valid_when_the_invalid_default_is_used`, true, "DRAFT_4")
  }
  ...
  public fun the_default_keyword_does_not_do_anything_if_the_property_is_missing(): Unit {
    ...
    val `an_explicit_property_value_is_checked_against_maximum_passing` = "{\"alpha\":1}"
    run_test(schema, `an_explicit_property_value_is_checked_against_maximum_passing`, true,
        "DRAFT_4")
    val `an_explicit_property_value_is_checked_against_maximum_failing` = "{\"alpha\":5}"
