...
public class ItemsTest {
  ...
  public fun a_schema_given_for_items(): Unit {
    ...
    val `wrong_type_of_items` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `wrong_type_of_items`, false, "DRAFT_6")
    ...
    val `JavaScript_pseudo_array_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `JavaScript_pseudo_array_is_valid`, true, "DRAFT_6")
  }
  ...
  public fun an_array_of_schemas_for_items(): Unit {
    ...
    val `correct_types` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `correct_types`, true, "DRAFT_6")
    val `wrong_types` = """
        |[
        |    "foo",
        |    1
        |]
        """.trimMargin()
    run_test(schema, `wrong_types`, false, "DRAFT_6")
    val `incomplete_array_of_items` = """
        |[
        |    1
        |]
        """.trimMargin()
    run_test(schema, `incomplete_array_of_items`, true, "DRAFT_6")
    val `array_with_additional_items` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_additional_items`, true, "DRAFT_6")
    val `empty_array` = """
        |[
        |]
        """.trimMargin()
  ...
  public fun items_with_boolean_schema_true(): Unit {
    ...
    val `any_array_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `any_array_is_valid`, true, "DRAFT_6")
  ...
  public fun items_with_boolean_schemas(): Unit {
    ...
    val `array_with_one_item_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_one_item_is_valid`, true, "DRAFT_6")
    val `array_with_two_items_is_invalid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_two_items_is_invalid`, false, "DRAFT_6")
    val `empty_array_is_valid` = """
        |[
        |]
        """.trimMargin()
  ...
  public fun items_and_subitems(): Unit {
    ...
    val `too_many_items` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `too_many_items`, false, "DRAFT_6")
    val `too_many_sub_items` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `too_many_sub_items`, false, "DRAFT_6")
    val `wrong_item` = """
        |[
        |    {
        |        "foo": null
        ...
        |]
        """.trimMargin()
    run_test(schema, `wrong_item`, false, "DRAFT_6")
    val `wrong_sub_item` = """
        |[
        |    [
        |        {
        ...
        |]
        """.trimMargin()
    run_test(schema, `wrong_sub_item`, false, "DRAFT_6")
    val `fewer_items_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `fewer_items_is_valid`, true, "DRAFT_6")
  }
  ...
  public fun nested_items(): Unit {
    ...
    val `valid_nested_array` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `valid_nested_array`, true, "DRAFT_6")
    val `nested_array_with_invalid_type` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `nested_array_with_invalid_type`, false, "DRAFT_6")
    val `not_deep_enough` = """
        |[
        |    [
        |        [
        ...
        |]
        """.trimMargin()
    run_test(schema, `not_deep_enough`, false, "DRAFT_6")
  }
}
