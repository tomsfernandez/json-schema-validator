...
public class MaximumTest {
  ...
  public fun maximum_validation_with_unsigned_integer(): Unit {
    ...
    run_test(schema, `below_the_maximum_is_invalid`, true, "DRAFT_6")
    val `boundary_point_integer_is_valid` = """300"""
    run_test(schema, `boundary_point_integer_is_valid`, true, "DRAFT_6")
    val `boundary_point_float_is_valid` = """300.0"""
    run_test(schema, `boundary_point_float_is_valid`, true, "DRAFT_6")
