...
public class MinLengthTest {
  ...
  public fun minLength_validation(): Unit {
    ...
    run_test(schema, `one_supplementary_Unicode_code_point_is_not_long_enough`, false, "DRAFT_6")
  }
}
