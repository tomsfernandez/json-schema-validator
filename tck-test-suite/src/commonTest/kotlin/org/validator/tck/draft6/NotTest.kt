...
public class NotTest {
  ...
  public fun not(): Unit {
    val schema = """
        ...
        """.trimMargin()
    val `allowed` = """"foo""""
    run_test(schema, `allowed`, true, "DRAFT_6")
    val `disallowed` = """1"""
    run_test(schema, `disallowed`, false, "DRAFT_6")
  }
  ...
  public fun not_multiple_types(): Unit {
    ...
    run_test(schema, `other_mismatch`, false, "DRAFT_6")
  }
  ...
  public fun not_more_complex_schema(): Unit {
    ...
    val `other_match` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `other_match`, true, "DRAFT_6")
    val `mismatch` = """
        |{
        |    "foo": "bar"
        |}
  ...
  public fun forbidden_property(): Unit {
    ...
    val `property_present` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `property_present`, false, "DRAFT_6")
    val `property_absent` = """
        |{
        |    "bar": 1,
        |    "baz": 2
        |}
        """.trimMargin()
    run_test(schema, `property_absent`, true, "DRAFT_6")
  }
