...
public class PropertiesTest {
  ...
  public fun object_properties_validation(): Unit {
    ...
    val `both_properties_present_and_valid_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_properties_present_and_valid_is_valid`, true, "DRAFT_6")
    val `one_property_invalid_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `one_property_invalid_is_invalid`, false, "DRAFT_6")
    val `both_properties_invalid_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_properties_invalid_is_invalid`, false, "DRAFT_6")
    val `doesn't_invalidate_other_properties` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `doesn't_invalidate_other_properties`, true, "DRAFT_6")
    val `ignores_arrays` = """
        |[
        |]
        """.trimMargin()
  ...
  public fun properties__patternProperties__additionalProperties_interaction(): Unit {
    ...
    val `property_validates_property` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `property_validates_property`, true, "DRAFT_6")
    val `property_invalidates_property` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `property_invalidates_property`, false, "DRAFT_6")
    val `patternProperty_invalidates_property` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `patternProperty_invalidates_property`, false, "DRAFT_6")
    val `patternProperty_validates_nonproperty` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `patternProperty_validates_nonproperty`, true, "DRAFT_6")
    val `patternProperty_invalidates_nonproperty` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `patternProperty_invalidates_nonproperty`, false, "DRAFT_6")
    val `additionalProperty_ignores_property` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `additionalProperty_ignores_property`, true, "DRAFT_6")
    val `additionalProperty_validates_others` = """
        |{
        |    "quux": 3
        |}
        """.trimMargin()
    run_test(schema, `additionalProperty_validates_others`, true, "DRAFT_6")
    val `additionalProperty_invalidates_others` = """
        |{
        |    "quux": "foo"
        |}
        """.trimMargin()
    run_test(schema, `additionalProperty_invalidates_others`, false, "DRAFT_6")
  }
  ...
  public fun properties_with_boolean_schema(): Unit {
    ...
    val `no_property_present_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `no_property_present_is_valid`, true, "DRAFT_6")
    val `only_'true'_property_present_is_valid` = """
        |{
        |    "foo": 1
        |}
        """.trimMargin()
    run_test(schema, `only_'true'_property_present_is_valid`, true, "DRAFT_6")
    val `only_'false'_property_present_is_invalid` = """
        |{
        |    "bar": 2
        |}
        """.trimMargin()
    run_test(schema, `only_'false'_property_present_is_invalid`, false, "DRAFT_6")
    val `both_properties_present_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_properties_present_is_invalid`, false, "DRAFT_6")
  }
  ...
  public fun properties_with_escaped_characters(): Unit {
    ...
    val `object_with_all_numbers_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_all_numbers_is_valid`, true, "DRAFT_6")
