...
public class PropertyNamesTest {
  ...
  public fun propertyNames_validation(): Unit {
    ...
    val `all_property_names_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `all_property_names_valid`, true, "DRAFT_6")
    val `some_property_names_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `some_property_names_invalid`, false, "DRAFT_6")
    val `object_without_properties_is_valid` = """
        |{
        |}
        """.trimMargin()
    run_test(schema, `object_without_properties_is_valid`, true, "DRAFT_6")
    val `ignores_arrays` = """
        |[
        |    1,
        |    2,
  ...
  public fun propertyNames_validation_with_pattern(): Unit {
    ...
    val `matching_property_names_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `matching_property_names_valid`, true, "DRAFT_6")
    val `non_matching_property_name_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `non_matching_property_name_is_invalid`, false, "DRAFT_6")
    val `object_without_properties_is_valid` = """
        |{
        |}
        """.trimMargin()
  ...
  public fun propertyNames_with_boolean_schema_true(): Unit {
    ...
    val `object_with_any_properties_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_any_properties_is_valid`, true, "DRAFT_6")
  ...
  public fun propertyNames_with_boolean_schema_false(): Unit {
    ...
    val `object_with_any_properties_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_any_properties_is_invalid`, false, "DRAFT_6")
    val `empty_object_is_valid` = """
        |{
        |}
        """.trimMargin()
