...
public class RequiredTest {
  ...
  public fun required_validation(): Unit {
    ...
    val `present_required_property_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `present_required_property_is_valid`, true, "DRAFT_6")
    val `non_present_required_property_is_invalid` = """
        |{
        |    "bar": 1
        |}
        """.trimMargin()
    run_test(schema, `non_present_required_property_is_invalid`, false, "DRAFT_6")
    val `ignores_arrays` = """
        |[
        |]
        """.trimMargin()
  ...
  public fun required_default_validation(): Unit {
    ...
    val `not_required_by_default` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `not_required_by_default`, true, "DRAFT_6")
  }
  ...
  public fun required_with_empty_array(): Unit {
    ...
    val `property_not_required` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `property_not_required`, true, "DRAFT_6")
  }
  ...
  public fun required_with_escaped_characters(): Unit {
    ...
    val `object_with_all_properties_present_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_all_properties_present_is_valid`, true, "DRAFT_6")
    val `object_with_some_properties_missing_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_some_properties_missing_is_invalid`, false, "DRAFT_6")
  }
}
