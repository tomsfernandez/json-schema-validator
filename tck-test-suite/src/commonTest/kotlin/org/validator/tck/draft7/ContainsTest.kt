...
public class ContainsTest {
  ...
  public fun contains_keyword_validation(): Unit {
    ...
    val `array_with_item_matching_schema_5_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_item_matching_schema_5_is_valid`, true, "DRAFT_7")
    val `array_with_item_matching_schema_6_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_item_matching_schema_6_is_valid`, true, "DRAFT_7")
    val `array_with_two_items_matching_schema_5__6_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_two_items_matching_schema_5__6_is_valid`, true, "DRAFT_7")
    val `array_without_items_matching_schema_is_invalid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_without_items_matching_schema_is_invalid`, false, "DRAFT_7")
    ...
    val `not_array_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `not_array_is_valid`, true, "DRAFT_7")
  }
  ...
  public fun contains_keyword_with_const_keyword(): Unit {
    ...
    val `array_with_item_5_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_item_5_is_valid`, true, "DRAFT_7")
    val `array_with_two_items_5_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_with_two_items_5_is_valid`, true, "DRAFT_7")
    val `array_without_item_5_is_invalid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `array_without_item_5_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun contains_keyword_with_boolean_schema_true(): Unit {
    ...
    val `any_non_empty_array_is_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `any_non_empty_array_is_valid`, true, "DRAFT_7")
    val `empty_array_is_invalid` = """
        |[
        |]
        """.trimMargin()
  ...
  public fun contains_keyword_with_boolean_schema_false(): Unit {
    ...
    run_test(schema, `non_arrays_are_valid`, true, "DRAFT_7")
  }
  ...
  public fun `items_+_contains`(): Unit {
    ...
    val `matches_items__does_not_match_contains` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `matches_items__does_not_match_contains`, false, "DRAFT_7")
    val `does_not_match_items__matches_contains` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `does_not_match_items__matches_contains`, false, "DRAFT_7")
    val `matches_both_items_and_contains` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `matches_both_items_and_contains`, true, "DRAFT_7")
    val `matches_neither_items_nor_contains` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `matches_neither_items_nor_contains`, false, "DRAFT_7")
  }
