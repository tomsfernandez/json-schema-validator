...
public class EnumTest {
  ...
  public fun simple_enum_validation(): Unit {
    ...
    run_test(schema, `one_of_the_enum_is_valid`, true, "DRAFT_7")
    val `something_else_is_invalid` = """4"""
    run_test(schema, `something_else_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun heterogeneous_enum_validation(): Unit {
    ...
    val `objects_are_deep_compared` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `objects_are_deep_compared`, false, "DRAFT_7")
    val `valid_object_matches` = """
        |{
        |    "foo": 12
        |}
        """.trimMargin()
    run_test(schema, `valid_object_matches`, true, "DRAFT_7")
    val `extra_properties_in_object_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `extra_properties_in_object_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun enums_in_properties(): Unit {
    ...
    val `both_properties_are_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_properties_are_valid`, true, "DRAFT_7")
    val `wrong_foo_value` = """
        |{
        |    "foo": "foot",
        |    "bar": "bar"
        |}
        """.trimMargin()
    run_test(schema, `wrong_foo_value`, false, "DRAFT_7")
    val `wrong_bar_value` = """
        |{
        |    "foo": "foo",
        |    "bar": "bart"
        |}
        """.trimMargin()
    run_test(schema, `wrong_bar_value`, false, "DRAFT_7")
    val `missing_optional_property_is_valid` = """
        |{
        |    "bar": "bar"
        |}
        """.trimMargin()
    run_test(schema, `missing_optional_property_is_valid`, true, "DRAFT_7")
    val `missing_required_property_is_invalid` = """
        |{
        |    "foo": "foo"
        |}
        """.trimMargin()
    run_test(schema, `missing_required_property_is_invalid`, false, "DRAFT_7")
    val `missing_all_properties_is_invalid` = """
        |{
        |}
        """.trimMargin()
    run_test(schema, `missing_all_properties_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun enum_with_escaped_characters(): Unit {
    ...
    run_test(schema, `member_1_is_valid`, true, "DRAFT_7")
    val `member_2_is_valid` = """"foo\\rbar""""
    run_test(schema, `member_2_is_valid`, true, "DRAFT_7")
    val `another_string_is_invalid` = """"abc""""
    run_test(schema, `another_string_is_invalid`, false, "DRAFT_7")
  }
