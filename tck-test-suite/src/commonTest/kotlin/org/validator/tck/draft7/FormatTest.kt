...
public class FormatTest {
  ...
  public fun email_format(): Unit {
    ...
    run_test(schema, `all_string_formats_ignore_integers`, true, "DRAFT_7")
    val `all_string_formats_ignore_floats` = """13.7"""
    run_test(schema, `all_string_formats_ignore_floats`, true, "DRAFT_7")
    val `all_string_formats_ignore_objects` = """
        |{
        |}
        """.trimMargin()
    run_test(schema, `all_string_formats_ignore_objects`, true, "DRAFT_7")
    val `all_string_formats_ignore_arrays` = """
        |[
        |]
        """.trimMargin()
    run_test(schema, `all_string_formats_ignore_arrays`, true, "DRAFT_7")
    val `all_string_formats_ignore_booleans` = """false"""
    run_test(schema, `all_string_formats_ignore_booleans`, true, "DRAFT_7")
    val `all_string_formats_ignore_nulls` = """null"""
    run_test(schema, `all_string_formats_ignore_nulls`, true, "DRAFT_7")
  }
