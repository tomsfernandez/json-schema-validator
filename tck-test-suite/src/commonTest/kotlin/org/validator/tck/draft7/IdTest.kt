...
public class IdTest {
  ...
  public fun id_inside_an_enum_is_not_a_real_identifier(): Unit {
    ...
    val `exact_match_to_enum__and_type_matches` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `exact_match_to_enum__and_type_matches`, true, "DRAFT_7")
    val `match_$ref_to_id` = """"a string to match #/definitions/id_in_enum""""
    run_test(schema, `match_$ref_to_id`, true, "DRAFT_7")
    val `no_match_on_enum_or_$ref_to_id` = """1"""
    run_test(schema, `no_match_on_enum_or_$ref_to_id`, false, "DRAFT_7")
  }
}
