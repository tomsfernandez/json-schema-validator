...
public class OneOfTest {
  ...
  public fun oneOf(): Unit {
    ...
    run_test(schema, `first_oneOf_valid`, true, "DRAFT_7")
    val `second_oneOf_valid` = """2.5"""
    run_test(schema, `second_oneOf_valid`, true, "DRAFT_7")
    val `both_oneOf_valid` = """3"""
    run_test(schema, `both_oneOf_valid`, false, "DRAFT_7")
    val `neither_oneOf_valid` = """1.5"""
    run_test(schema, `neither_oneOf_valid`, false, "DRAFT_7")
  }
  ...
  public fun oneOf_with_base_schema(): Unit {
    ...
    run_test(schema, `one_oneOf_valid`, true, "DRAFT_7")
  ...
  public fun oneOf_complex_types(): Unit {
    ...
    val `first_oneOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `first_oneOf_valid_complex`, true, "DRAFT_7")
    val `second_oneOf_valid_complex` = """
        |{
        |    "foo": "baz"
        |}
        """.trimMargin()
    run_test(schema, `second_oneOf_valid_complex`, true, "DRAFT_7")
    val `both_oneOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_oneOf_valid_complex`, false, "DRAFT_7")
    val `neither_oneOf_valid_complex` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `neither_oneOf_valid_complex`, false, "DRAFT_7")
  }
  ...
  public fun oneOf_with_empty_schema(): Unit {
    ...
    run_test(schema, `one_valid___valid`, true, "DRAFT_7")
    val `both_valid___invalid` = """123"""
    run_test(schema, `both_valid___invalid`, false, "DRAFT_7")
  }
  ...
  public fun oneOf_with_required(): Unit {
    ...
    val `both_invalid___invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `both_invalid___invalid`, false, "DRAFT_7")
    val `first_valid___valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `first_valid___valid`, true, "DRAFT_7")
    val `second_valid___valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `second_valid___valid`, true, "DRAFT_7")
