...
public class PatternPropertiesTest {
  ...
  public fun patternProperties_validates_properties_matching_a_regex(): Unit {
    ...
    val `a_single_valid_match_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `a_single_valid_match_is_valid`, true, "DRAFT_7")
    val `multiple_valid_matches_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `multiple_valid_matches_is_valid`, true, "DRAFT_7")
    val `a_single_invalid_match_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `a_single_invalid_match_is_invalid`, false, "DRAFT_7")
    val `multiple_invalid_matches_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `multiple_invalid_matches_is_invalid`, false, "DRAFT_7")
    val `ignores_arrays` = """
        |[
        |    "foo"
        |]
  ...
  public fun multiple_simultaneous_patternProperties_are_validated(): Unit {
    ...
    val `a_simultaneous_match_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `a_simultaneous_match_is_valid`, true, "DRAFT_7")
    val `multiple_matches_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `multiple_matches_is_valid`, true, "DRAFT_7")
    val `an_invalid_due_to_one_is_invalid` = """
        |{
        |    "a": "bar"
        |}
        """.trimMargin()
    run_test(schema, `an_invalid_due_to_one_is_invalid`, false, "DRAFT_7")
    val `an_invalid_due_to_the_other_is_invalid` = """
        |{
        |    "aaaa": 31
        |}
        """.trimMargin()
    run_test(schema, `an_invalid_due_to_the_other_is_invalid`, false, "DRAFT_7")
    val `an_invalid_due_to_both_is_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `an_invalid_due_to_both_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun regexes_are_not_anchored_by_default_and_are_case_sensitive(): Unit {
    ...
    val `non_recognized_members_are_ignored` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `non_recognized_members_are_ignored`, true, "DRAFT_7")
    val `recognized_members_are_accounted_for` = """
        |{
        |    "a31b": null
        |}
        """.trimMargin()
    run_test(schema, `recognized_members_are_accounted_for`, false, "DRAFT_7")
    val `regexes_are_case_sensitive` = """
        |{
        |    "a_x_3": 3
        |}
        """.trimMargin()
    run_test(schema, `regexes_are_case_sensitive`, true, "DRAFT_7")
    val `regexes_are_case_sensitive__2` = """
        |{
        |    "a_X_3": 3
        |}
        """.trimMargin()
    run_test(schema, `regexes_are_case_sensitive__2`, false, "DRAFT_7")
  }
  ...
  public fun patternProperties_with_boolean_schemas(): Unit {
    ...
    val `object_with_property_matching_schema_true_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_property_matching_schema_true_is_valid`, true, "DRAFT_7")
    val `object_with_property_matching_schema_false_is_invalid` = """
        |{
        |    "bar": 2
        |}
        """.trimMargin()
    run_test(schema, `object_with_property_matching_schema_false_is_invalid`, false, "DRAFT_7")
