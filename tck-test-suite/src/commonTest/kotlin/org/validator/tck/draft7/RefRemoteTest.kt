...
public class RefRemoteTest {
  ...
  public fun fragment_within_remote_ref(): Unit {
    ...
    run_test(schema, `remote_fragment_valid`, true, "DRAFT_7")
    val `remote_fragment_invalid` = """"a""""
    run_test(schema, `remote_fragment_invalid`, false, "DRAFT_7")
  }
  ...
  public fun ref_within_remote_ref(): Unit {
    ...
    run_test(schema, `ref_within_ref_valid`, true, "DRAFT_7")
    val `ref_within_ref_invalid` = """"a""""
    run_test(schema, `ref_within_ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun base_URI_change(): Unit {
    ...
    val `base_URI_change_ref_valid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `base_URI_change_ref_valid`, true, "DRAFT_7")
    val `base_URI_change_ref_invalid` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `base_URI_change_ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun remote_ref_with_ref_to_definitions(): Unit {
    ...
    val `invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `invalid`, false, "DRAFT_7")
    val `valid` = """
        |{
        |    "bar": "a"
        |}
