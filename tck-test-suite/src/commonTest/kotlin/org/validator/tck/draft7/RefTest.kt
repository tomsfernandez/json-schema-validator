...
public class RefTest {
  ...
  public fun root_pointer_ref(): Unit {
    ...
    val `match` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `match`, true, "DRAFT_7")
    val `recursive_match` = """
        |{
        |    "foo": {
        |        "foo": false
        ...
        |}
        """.trimMargin()
    run_test(schema, `recursive_match`, true, "DRAFT_7")
    val `mismatch` = """
        |{
        |    "bar": false
        |}
        """.trimMargin()
    run_test(schema, `mismatch`, false, "DRAFT_7")
    val `recursive_mismatch` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `recursive_mismatch`, false, "DRAFT_7")
  }
  ...
  public fun relative_pointer_ref_to_array(): Unit {
    ...
    val `match_array` = """
        ...
        |]
        """.trimMargin()
    run_test(schema, `match_array`, true, "DRAFT_7")
    val `mismatch_array` = """
        |[
        |    1,
        |    "foo"
        |]
        """.trimMargin()
    run_test(schema, `mismatch_array`, false, "DRAFT_7")
  }
  ...
  public fun escaped_pointer_ref(): Unit {
    ...
    val `slash_invalid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `slash_invalid`, false, "DRAFT_7")
    val `tilde_invalid` = """
        |{
        |    "tilde": "aoeu"
        |}
        """.trimMargin()
    run_test(schema, `tilde_invalid`, false, "DRAFT_7")
    val `percent_invalid` = """
        |{
        |    "percent": "aoeu"
        |}
        """.trimMargin()
    run_test(schema, `percent_invalid`, false, "DRAFT_7")
    val `slash_valid` = """
        |{
        |    "slash": 123
        |}
        """.trimMargin()
    run_test(schema, `slash_valid`, true, "DRAFT_7")
    val `tilde_valid` = """
        |{
        |    "tilde": 123
        |}
        """.trimMargin()
    run_test(schema, `tilde_valid`, true, "DRAFT_7")
    val `percent_valid` = """
        |{
        |    "percent": 123
        |}
        """.trimMargin()
    run_test(schema, `percent_valid`, true, "DRAFT_7")
  }
  ...
  public fun nested_refs(): Unit {
    ...
    run_test(schema, `nested_ref_valid`, true, "DRAFT_7")
    val `nested_ref_invalid` = """"a""""
    run_test(schema, `nested_ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun ref_overrides_any_sibling_keywords(): Unit {
    ...
    val `ref_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `ref_valid`, true, "DRAFT_7")
    val `ref_valid__maxItems_ignored` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `ref_valid__maxItems_ignored`, true, "DRAFT_7")
    val `ref_invalid` = """
        |{
        |    "foo": "string"
        |}
        """.trimMargin()
    run_test(schema, `ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun `$ref_prevents_a_sibling_$id_from_changing_the_base_uri`(): Unit {
    ...
    run_test(schema, `$ref_resolves_to__definitions_foo__data_validates`, true, "DRAFT_7")
    val `$ref_resolves_to__definitions_foo__data_does_not_validate` = """1"""
    run_test(schema, `$ref_resolves_to__definitions_foo__data_does_not_validate`, false, "DRAFT_7")
  }
  ...
  public fun remote_ref__containing_refs_itself(): Unit {
    ...
    val `remote_ref_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `remote_ref_valid`, true, "DRAFT_7")
    val `remote_ref_invalid` = """
        |{
        |    "minLength": -1
        |}
        """.trimMargin()
    run_test(schema, `remote_ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun `property_named_$ref_that_is_not_a_reference`(): Unit {
    ...
    val `property_named_$ref_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `property_named_$ref_valid`, true, "DRAFT_7")
    val `property_named_$ref_invalid` = """
        |{
        |    "${'$'}ref": 2
        |}
        """.trimMargin()
    run_test(schema, `property_named_$ref_invalid`, false, "DRAFT_7")
  }
  ...
  public fun `$ref_to_boolean_schema_true`(): Unit {
    ...
    run_test(schema, `any_value_is_valid`, true, "DRAFT_7")
  }
  ...
  public fun `$ref_to_boolean_schema_false`(): Unit {
    ...
    run_test(schema, `any_value_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun Recursive_references_between_schemas(): Unit {
    ...
    val `valid_tree` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `valid_tree`, true, "DRAFT_7")
    val `invalid_tree` = """
        |{
        |    "meta": "root",
        |    "nodes": [
        ...
        |}
        """.trimMargin()
    run_test(schema, `invalid_tree`, false, "DRAFT_7")
  }
  ...
  public fun refs_with_quote(): Unit {
    ...
    val `object_with_numbers_is_valid` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `object_with_numbers_is_valid`, true, "DRAFT_7")
    val `object_with_strings_is_invalid` = """
        |{
        |    "foo\"bar": "1"
        |}
        """.trimMargin()
    run_test(schema, `object_with_strings_is_invalid`, false, "DRAFT_7")
  }
  ...
  public fun `naive_replacement_of_$ref_with_its_destination_is_not_correct`(): Unit {
    ...
    val `match_the_enum_exactly` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `match_the_enum_exactly`, true, "DRAFT_7")
  }
  ...
  public fun refs_with_relative_uris_and_defs(): Unit {
    ...
    val `invalid_on_inner_field` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `invalid_on_inner_field`, false, "DRAFT_7")
    val `invalid_on_outer_field` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `invalid_on_outer_field`, false, "DRAFT_7")
    val `valid_on_both_fields` = """
        ...
        |}
        """.trimMargin()
    run_test(schema, `valid_on_both_fields`, true, "DRAFT_7")
  }
